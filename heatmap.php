...
/**
 * @file heatmap.php
 * @description Show GG-Tracker using a heatmap 
 * @author Ebo Eppenga
 * @copyright 2013
 */
...
<html lang="en">
  <head>
    ...
    <!-- Google Heatmap script --><?php include "script_heatmap.php"; ?>
  </head>
      ...
      <div class="container">
        ...
        <div class="panel panel-info">
          <div class="panel-heading">
            <a href="fullscreen_heatmap.php"><img src="images/maximize.png" alt="maximize screen" class="pull-right" /></a>
